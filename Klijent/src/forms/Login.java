...
import FormClient.FormNewClient;
...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Login of bank employees");
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        try {
            ...
            Administrator administrator = ClientController.getInstance().login(d);
            ...
            if (e instanceof SocketException) {
                JOptionPane.showMessageDialog(rootPane, "Communication between servers has been lost");
                this.dispose();
                System.exit(0);
            } else {
